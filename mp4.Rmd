...
```{r}
plottingdata[["sign"]]=ifelse(plottingdata[["diff_rating"]] >= 0, "positive", "negative")
...
ggplot(data=plottingdata, aes(x=title, y=diff_rating, fill=sign))+ 
  ...
  theme(text = element_text(size=6),
        axis.text.x = element_text(angle = 90, hjust = 1), panel.background = element_rect(fill = "black"))
```
